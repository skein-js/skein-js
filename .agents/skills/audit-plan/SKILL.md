...
| E   | Demand and disconfirmation       | The disconfirmation checklist                                                            | [docs/proposals/README.md](../../../docs/proposals/README.md) as the worked exemplar — both entries record what their implementation _rejected_: a named workflow, success criteria measured _in user code outside this repo_, specific non-goals, genuinely open questions, and a phase 1 that can kill the plan                                                                                                     |
