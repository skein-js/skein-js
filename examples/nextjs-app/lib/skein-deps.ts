// Build the Agent Protocol runtime from graphs defined in this app — no `langgraph.json`. `createInMemoryDeps`
...
// Redis queue + Postgres store via `createInMemoryDeps({ ... }, { store, queue, checkpointer })` (see
...
export const deps = createInMemoryDeps({
  echo,
