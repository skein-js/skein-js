...
| **Cross-provider channel delivery**                                                      | `@skein-js/channels`                                             | LangGraph still chooses routes and writes custom output; Skein adapts an explicit destination intent to its existing durable channel callback/outbox. |
